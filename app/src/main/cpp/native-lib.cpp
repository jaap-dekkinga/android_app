...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_dekidea_tuneurl_service_SoundListenerService_extractFingerprint(JNIEnv* env, jobject /* this */, jobject byteBuffer, jint waveLength) {
...
Java_com_dekidea_tuneurl_service_SoundListenerService_getSimilarity(JNIEnv* env, jobject /* this */, jobject byteBuffer1, jint waveLength1, jobject byteBuffer2, jint waveLength2) {
